<template>
  <div>
    ...
    <div v-else-if="!localIsProcessing">
      <p>No analysis reports available. Please try analyzing different tickers.</p>
    </div>
  </div>
</template>
