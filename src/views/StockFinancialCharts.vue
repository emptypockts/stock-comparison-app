<template>
  <div v-if="tickers.length > 0">
    <div class="terminal">
      <span>eacsa> </span>trends:
    </div>

    <div>
      <button :disabled="tickers.length === 0" @click="toggleView" class="buttons">
        {{ isYearlyView ? "⟬⟬ quartetly view ⟭⟭" : "⟬⟬ yearly view ⟭⟭" }}
    ...
    <div>
      ...
      <div v-if="tickers.length" class="chart-container">
        ...
        <div class="chart-box">
          ...
          <apexcharts v-if="pickStockPriceSeries.length" type="line" :options="chartOptions"
            :series="pickStockPriceSeries">
          </apexcharts>
        ...
        <div class="chart-box">
          ...
          <p>When not moving at a fairly even pace, this could indicate that net income is not as muscular as it
            appears.
          </p>
        </div>
        ...
        <div class="chart-box">
          ...
          <apexcharts v-if="PickEPSSeries.length" type="line" :options="chartOptions" :series="PickEPSSeries">
          </apexcharts>
