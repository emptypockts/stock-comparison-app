  ...
  methods: {
    async fetchEconomicData() {
      ...
      const descriptions = {
        ...
        "U6RATE": "U-6 Unemployment Rate captures broader labor underutilization in the U.S. economy. It includes unemployed workers, those marginally attached to the labor force (who want work but stopped actively seeking), and part-time workers who prefer full-time jobs but can’t find them. A rising U-6 signals hidden weakness in the labor market beyond the headline unemployment rate (U-3), often preceding slowdowns or recessions. Persistent gaps between U-3 and U-6 reflect underemployment and structural labor market issues, impacting wages, consumption, and long-term growth."
      };
      this.loading = true;
      try {
